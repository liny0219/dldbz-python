...
def load_battle_configurations(instance):
    instance.check_battle_ui_refs = cfg_battle.get("check.check_battle_ui_refs")   # 检查战斗图片
    instance.check_round_ui_refs = cfg_battle.get("check.check_round_ui_refs")    # 检查回合结束图片
    instance.check_skill_ui_refs = cfg_battle.get("check.check_skill_ui_refs")    # 检查技能界面图片
